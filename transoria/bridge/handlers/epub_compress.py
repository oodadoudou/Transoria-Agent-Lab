...
def register(router: BridgeRouter, *, service: TaskService) -> None:
    def preview(payload: Mapping[str, object]) -> dict[str, object]:
        ...
        return service.preview_epub_compress(
    ...
    def start_task(payload: Mapping[str, object]) -> dict[str, object]:
        ...
        for index, raw in enumerate(raw_actions):
            ...
            actions.append(raw)
        return service.start_epub_compress(
    ...
    def stop_task(payload: Mapping[str, object]) -> dict[str, object]:
        return service.stop_task(
            kind="epub_compress", task_id=expect_string(payload, "task_id")
        )
    ...
    def probe_continuable(_payload: Mapping[str, object]) -> dict[str, object]:
        return service.probe_continuable(kind="epub_compress")
    ...
    def list_recent_tasks(payload: Mapping[str, object]) -> dict[str, object]:
        ...
        return service.list_recent_tasks(kind="epub_compress", limit=limit)
    ...
    def read_report(payload: Mapping[str, object]) -> dict[str, object]:
        return service.read_epub_compress_report(
    ...
    router.register("epub_compress.preview", preview)
    router.register("epub_compress.start_task", start_task)
    router.register("epub_compress.stop_task", stop_task)
    router.register("epub_compress.pause_task", pause_task)
    router.register("epub_compress.continue_task", continue_task)
    router.register("epub_compress.probe_continuable", probe_continuable)
    router.register("epub_compress.read_snapshot", read_snapshot)
    router.register("epub_compress.list_recent_tasks", list_recent_tasks)
    router.register("epub_compress.read_artifacts", read_artifacts)
    router.register("epub_compress.read_report", read_report)
    router.register("epub_compress.list_failed_subtasks", list_failed_subtasks)
