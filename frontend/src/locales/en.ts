...
export const en: Messages = {
  ...
  agentLab: {
    ...
    sub: "Let the agent understand the request and prepare configuration drafts. Nothing is saved until you confirm it.",
    configTitle: "Workspace config",
    configSub:
    ...
    termExtractPrompt: "Term extraction prompt",
    termReviewPrompt: "Term review prompt",
    noModel: "No model selected",
    noPrompt: "No prompt selected",
    modelNotConfigured: "API key missing",
    chatTitle: "Chat",
    chatSub:
    ...
    inventorySub:
      "Concurrency and rate limits still come from model profiles. The agent does not reimplement task parallelism.",
  ...
  glossaryReview: {
    ...
    review: {
      ...
      exportJson: "Export JSON table",
      importJson: "Import JSON table",
      jsonBusy: "Working…",
      ...
      exportJsonSuccess: "Exported {n} rows to {path}.",
      exportJsonFailed: "JSON export failed: {reason}",
      importJsonSuccess: "Imported {n} rows from JSON.",
      importJsonFailed: "JSON import failed: {reason}",
      dirty: "Unsaved edits",
    },
  },
  generalTools: {
