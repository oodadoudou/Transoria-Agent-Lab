...
export const zh: Messages = {
  ...
  agentLab: {
    crumb: "Agent Lab",
    title: "Agent 工作区",
    sub: "先让 Agent 理解需求、准备配置草案；任何配置写入都必须由你确认后执行。",
    configTitle: "工作区配置",
    configSub:
    ...
    termExtractPrompt: "术语提取 Prompt",
    termReviewPrompt: "术语审核 Prompt",
    noModel: "未选择模型",
    noPrompt: "未选择 Prompt",
    ...
    sending: "发送中…",
    draftTitle: "待确认草案",
    draftSub: "确认前不会写入配置，也不会启动任务。",
    applyDraft: "应用",
    discardDraft: "放弃",
    adjustDraft: "调整",
    adjustDraftTitle: "调整草案",
    adjustDraftPlaceholder: "输入要调整的地方，例如：Prompt 名称改成……",
    submitAdjustment: "重新生成草案",
    cancelAdjustment: "取消",
    noDraft: "暂无待确认草案。",
    inventoryTitle: "可用模型",
    inventorySub:
    ...
    thinkingTitle: "Agent 正在处理",
    thinkingLead: "模型正在思考并准备回复。",
    thinkingSteps: ["整理对话上下文", "检查当前配置", "准备回复或确认草案"],
    showProcessDetails: "查看处理过程",
    hideProcessDetails: "收起处理过程",
    processDisclosure:
      "这里显示 Agent 可见的处理状态，不展示模型隐藏推理原文。",
    expandMessage: "展开全部",
    collapseMessage: "收起",
    resendMessage: "重新发送",
    copyMessage: "复制",
    copiedMessage: "已复制",
    activeRecipeTitle: "当前预设",
    ...
    recipesSectionTitle: "我的预设",
    recipesSectionSub: "新建、编辑或应用预设。应用后聊天页会显示当前生效内容。",
    activeStageTitle: "当前阶段选择",
    activeStageSub:
      "由最近应用的预设决定。在下面的预设列表里点击「应用」可切换。",
    stageModel: {
      translation: "翻译模型",
      term_extract: "术语提取模型",
      term_review: "术语审核模型",
    ...
    stagePrompt: {
      ...
      term_extract: "术语提取 Prompt",
      term_review: "术语审核 Prompt",
    },
    stageEmptyModel: "未选择模型",
    stageEmptyPrompt: "未选择 Prompt",
    recipeNew: "+ 新建预设",
    recipeEdit: "编辑",
    recipeApply: "应用",
    recipeDelete: "删除",
    recipeApplied: "当前已应用",
    recipeEmpty: "尚未创建预设。点击右上角「新建预设」开始配置。",
    recipeModalTitleCreate: "新建预设",
    recipeModalTitleEdit: "编辑预设",
    recipeFieldName: "名称",
    recipeFieldNamePlaceholder: "例如：高质量校审 / 便宜量产",
    recipeFieldDescription: "描述（可选）",
    recipeFieldDescriptionPlaceholder: "简短说明这套预设的适用场景。",
    recipeSave: "保存",
    recipeCancel: "取消",
    recipeDeleteConfirm: "确认删除这个预设？应用过它的项目不受影响。",
  },
  translation: {
    crumb: "翻译",
    settings: {
  ...
  glossaryReview: {
    ...
    review: {
      ...
      delete: "删除此条",
      deleteSelected: "删除选中",
      exportJson: "导出 JSON 表",
      importJson: "导入 JSON 表",
      jsonBusy: "处理中…",
      ...
      failed: "保存失败：{reason}",
      exportJsonSuccess: "已导出 {n} 条到 {path}。",
      exportJsonFailed: "导出 JSON 失败：{reason}",
      importJsonSuccess: "已从 JSON 导入 {n} 条。",
      importJsonFailed: "导入 JSON 失败：{reason}",
      dirty: "未保存的修改",
    },
  },
  generalTools: {
